...
#data load
file_path = r"/Users/austinjewett/Desktop/Purdue/AAE590/HW 2/DataSet_Disp_Import_csv.csv"
...
plt.title('RMSE & MAE per Fold (disp) (Lasso)')
plt.legend()
plt.grid(True)
...
plt.xlabel('Fold Number')
plt.ylabel('R² Score')
plt.title('R² per Fold (disp) (Lasso)')
plt.legend()
plt.grid(True)
...
plt.xlabel('Fold Number')
plt.ylabel('Error Metric')
plt.title('RMSE & MAE per Fold (disp) (Ridge)')
plt.legend()
plt.grid(True)
...
plt.xlabel('Fold Number')
plt.ylabel('R² Score')
plt.title('R² per Fold (disp) (Ridge)')
plt.legend()
plt.grid(True)
